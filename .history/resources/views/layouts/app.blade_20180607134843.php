                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle disabled" href="/show-services" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false">
                                Sites
                            </a>
                        ...
                        {{-- dropdown Services --}}
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="/show-services" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false">
                                Services
                            </a>
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <li class="nav-item dropdown">
                            <a href="/show-expired" class="nav-link dropdown-toggle" id="navbarDropdownPayments" data-toggle="dropdown" aria-haspopup="true"
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="/show-expired-all" role="tab" aria-controls="pills-contact"
                                aria-selected="false">Show All Expired</a>
                        </li>
                        <!-- <li class="nav-item dropdown">
